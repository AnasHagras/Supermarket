...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=4124868235ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=finalproject&table=employees">`finalproject`.`employees`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=finalproject&table=users">`finalproject`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=finalproject&table=outgoings">`finalproject`.`outgoings`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=finalproject&table=receipts">`finalproject`.`receipts`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=finalproject&table=catagories">`finalproject`.`catagories`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=finalproject&table=invoices">`finalproject`.`invoices`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=finalproject&table=products">`finalproject`.`products`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=finalproject&table=invoice_products">`finalproject`.`invoice_products`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=finalproject&table=incomings">`finalproject`.`incomings`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=finalproject&table=companies">`finalproject`.`companies`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="48475b70277b2f50676d732a2e262c78">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="finalproject" targettable="employees">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `employees`</span>
                        </div>
